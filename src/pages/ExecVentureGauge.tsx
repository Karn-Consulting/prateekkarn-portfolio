      ...
      <div className="min-h-screen bg-[#faf9f7]">
        ...
        <section className="py-16 bg-white border-y border-[#e8e6e1]">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[#5a5a5a] text-center mb-12 max-w-2xl mx-auto">
              The tool provides clear signals based on the risk-adjusted financial outcomes.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-6 bg-[#f5f4f2] rounded-sm border border-[#e8e6e1]">
                <div className="w-12 h-12 mb-4 flex items-center justify-center bg-emerald-100 rounded-full">
                  <CheckCircle className="w-6 h-6 text-emerald-600" />
                </div>
                <h3 className="font-medium text-[#1a1a1a] mb-2">Proceed</h3>
                <p className="text-sm text-[#5a5a5a]">Initiative meets all financial and strategic thresholds under realistic conditions.</p>
              </div>
              <div className="p-6 bg-[#f5f4f2] rounded-sm border border-[#e8e6e1]">
                <div className="w-12 h-12 mb-4 flex items-center justify-center bg-amber-100 rounded-full">
                  <Shield className="w-6 h-6 text-amber-600" />
                </div>
                <h3 className="font-medium text-[#1a1a1a] mb-2">Proceed with Caution</h3>
                <p className="text-sm text-[#5a5a5a]">Initiative meets thresholds but has significant dependencies or risks that require mitigation.</p>
              </div>
              <div className="p-6 bg-[#f5f4f2] rounded-sm border border-[#e8e6e1]">
                <div className="w-12 h-12 mb-4 flex items-center justify-center bg-red-100 rounded-full">
                  <Target className="w-6 h-6 text-red-600" />
                </div>
                <h3 className="font-medium text-[#1a1a1a] mb-2">Re-evaluate</h3>
                <p className="text-sm text-[#5a5a5a]">Initiative does not meet investment thresholds or has excessive risk exposure.</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-[#5a5a5a]">Sensitivity analysis on key assumptions like adoption rate and value capture</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ArrowRight className="w-5 h-5 text-[#8b7355] flex-shrink-0 mt-0.5" />
                    <span className="text-[#5a5a5a]">Break-even analysis showing the minimum performance required to justify investment</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ArrowRight className="w-5 h-5 text-[#8b7355] flex-shrink-0 mt-0.5" />
