            ...
            <div className="relative w-full max-w-sm mx-auto lg:hidden order-2">
              <div className="relative w-full group">
                <img
                  ...
                  className="w-full h-auto rounded-none shadow-elevation grayscale group-hover:grayscale-0 transition-all duration-700 ease-in-out"
                />
                <div className="absolute inset-0 rounded-none bg-gradient-to-br from-accent/20 to-primary/10 group-hover:from-accent/5 group-hover:to-transparent transition-all duration-700 ease-in-out pointer-events-none"></div>
              </div>
            </div>
            ...
            <div className="mt-8 lg:mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start order-4 lg:order-none">
              ...
              >
                <Button 
                  variant="cta" 
                  size="lg"
                  className="font-semibold text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-6 h-auto w-full sm:w-auto group bg-[#9C8B6B] text-white hover:bg-[#7A6B4F]"
                >
              ...
              <Link to="/mywork">
                <Button 
                  variant="outline" 
                  size="lg"
                  className="font-semibold text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-6 h-auto w-full sm:w-auto group border-[#9C8B6B] text-[#9C8B6B] hover:opacity-80 hover:text-white transition-all duration-300"
                >
                  View My Work
                  <span className="ml-2 inline-block transition-transform duration-300 group-hover:translate-x-1">→</span>
                </Button>
