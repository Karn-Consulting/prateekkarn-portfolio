...
const BLOG_POSTS = [
  {
    ...
    excerpt: "Building the Self-Healing Business through a High-Resolution Digital Nervous System. A framework for creating adaptive organizations that sense, respond, and evolve in real-time.",
