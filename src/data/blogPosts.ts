...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: 1,
    slug: 'agentic-ai-marketing-implementation',
    title: 'Agentic AI in Marketing: The Complete Implementation Framework for Enterprise Growth',
    excerpt: 'A practical, battle-tested framework for implementing agentic AI in marketing—from autonomous lead nurturing to real-time campaign optimization.',
